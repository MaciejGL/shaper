					...
					<div className="space-y-2">
						...
						{isEditing ? (
							...
							>
								...
								<SelectContent>
									<SelectItem value={GQLFitnessLevel.Beginner}>Beginner</SelectItem>
									<SelectItem value={GQLFitnessLevel.Intermediate}>
										Intermediate
									</SelectItem>
									<SelectItem value={GQLFitnessLevel.Advanced}>Advanced</SelectItem>
					...
					<div className="space-y-2">
						...
						{isEditing ? (
							...
							>
								...
								<SelectContent>
									<SelectItem value={GQLActivityLevel.Sedentary}>Sedentary</SelectItem>
									<SelectItem value={GQLActivityLevel.Light}>Light</SelectItem>
									<SelectItem value={GQLActivityLevel.Moderate}>Moderate</SelectItem>
									<SelectItem value={GQLActivityLevel.Active}>Active</SelectItem>
									<SelectItem value={GQLActivityLevel.Athlete}>Athlete</SelectItem>
								</SelectContent>
							</Select>
						) : (
