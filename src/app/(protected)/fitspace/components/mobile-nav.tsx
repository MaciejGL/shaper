...
export function MobileNav({ useDeepLinks = false }: MobileNavProps = {}) {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md dark:bg-sidebar/95 pb-[var(--safe-area-bottom-nav)] safe-area-x border-t border-border/50">
