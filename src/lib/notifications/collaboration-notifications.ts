  ...
  await createNotification(
    {
      ...
      message: `${addedByName} added you as a collaborator to training plan "${planTitle}" with ${permission.toLowerCase()} access`,
  ...
  await createNotification(
    {
      ...
      message: `${removedByName} removed you as a collaborator from training plan "${planTitle}"`,
      relatedItemId: planId,
  ...
  await createNotification(
    {
      ...
      message: `${addedByName} added you as a collaborator to meal plan "${planTitle}" with ${permission.toLowerCase()} access`,
      relatedItemId: planId,
  ...
  await createNotification(
    {
      ...
      message: `${removedByName} removed you as a collaborator from meal plan "${planTitle}"`,
      relatedItemId: planId,
