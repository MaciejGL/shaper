...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'bg-muted dark:bg-muted-foreground/10 text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[2px] shadow-neuro-light dark:shadow-neuro-dark',
        className,
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[state=active]:shadow-neuro-inset-light dark:data-[state=active]:shadow-neuro-inset-dark',
        className,
      )}
      {...props}
    />
