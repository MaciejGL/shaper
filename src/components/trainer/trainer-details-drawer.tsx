    ...
    >
      ...
      >
        <div className="flex flex-col h-full overflow-y-auto">
          <div className="min-h-0 flex-1 p-4 pt-0 pb-20">
            {/* Trainer Card Header */}
            <div className="-mx-4">
              <TrainerCard
                trainer={trainer}
                className="rounded-none border-x-0 border-t-0 rounded-b-2xl shadow-lg"
                classNameImage="rounded-b-2xl"
                classNameOverlay="rounded-b-2xl"
                classNameBadge="rounded-t-none"
                hideButton
              />
            </div>
                    ...
                    <p className="text-sm leading-relaxed">
                      {trainer.isAtCapacity ? (
                        ...
                        <>
                          ...
                          you'll receive a trainer service offer here and can
